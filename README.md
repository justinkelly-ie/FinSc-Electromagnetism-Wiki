# FinSc-Electromagnetism-Wiki

[![Idris 2 Verification](https://img.shields.io/badge/Idris_2-0.8.0-blue.svg)](https://www.idris-lang.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

**Literate Verification Suite & Specification Manual for Layer 3c (`FinSc-Electromagnetism`)**

`FinSc-Electromagnetism-Wiki` provides formal compile-time macro reflection proofs, QuickCheck property test suites, and literate Markdown specifications for **Layer 3c** of the non-linear discrete multiset physical law ecosystem.
...
```bash
idris2 --build FinSc-Electromagnetism-Wiki.ipkg
./build/exec/em-wiki
```
